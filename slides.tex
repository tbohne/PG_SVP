...
\begin{frame}
  ...
  \begin{itemize}
    \item Systematische Folge von einem \textquote{Center-of-Gravity} zum nächsten
    \item Jedes \textit{CoG} besitzt eine assoziierte Knotenmenge und eine resultierende Route
    \item Die Folge schreitet voran, bis ein Abbruchkriterium erfüllt ist
    \item Die beste generierte Route wird ausgewählt
  \end{itemize}
  \textbf{3 Schritte:}
  \begin{enumerate}
...
\begin{frame}
  \frametitle{3.) Center-of-Gravity}
  \textbf{Anschließend wird eine Route wie folgt generiert}:
  \begin{itemize}  
  ...
  \begin{itemize}
    ...
    \item Iterativer Prozess, bis dieselbe Route erneut entsteht
